...
func TestCommandSide_ResendInitialMail(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := r.ResendInitialUser(tt.args.ctx, tt.args.userID, domain.EmailAddress(tt.args.email), "", tt.args.resourceOwner, tt.args.secretGenerator, tt.args.authRequestID)
			if tt.res.err == nil {
